...
# Lists, not tuples: struct_def is embedded in placed features and must
# round-trip through project JSON unchanged (a tuple reloads as a list and
# breaks save/load equality).
_INSTALL_COST_CAD: dict[str, list[float]] = {
    "pond":             [400.0, 2000.0],
    "swale":            [150.0, 700.0],
