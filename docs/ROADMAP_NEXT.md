...
working across both documents. **Next free ID: F131.**
...
| **F127** | Curate the held animals — AB/SK nativity, common name, taxon | ✅ **V2.63** for the top 200 (159 admitted, 5,487 edges, 67% coverage). The **1,052-species tail is held**, worth ~2,800 more edges, and is now **F130** |
...
| **F130** | The 1,052-species tail F127 held: the animals below the top 200, worth ~2,800 edges. Same review shape, another afternoon | **open** — opened by V2.63 |
