...
| **F127** | Curate the 2,872 held animals — AB/prairie nativity, common name, taxon — to unlock 10,937 further GloBI edges | **open** — the 67 birds done as **F127a** in V2.60; 2,805 bees, leps and other insects remain |
| **F128** | Re-fetch GloBI with `includeObservations=true`: per-study citations, the life stages that would recover the dropped larval-host records, and the body part eaten, which would recover the dropped sapsucker and browse records | **open** — opened by V2.59 |
