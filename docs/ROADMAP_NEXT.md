...
working across both documents. **Next free ID: F129.**
...
| **F127** | Curate the 2,872 held animals — AB/prairie nativity, common name, taxon — to unlock 10,937 further GloBI edges | **open** — opened by V2.59 |
| **F128** | Re-fetch GloBI with `includeObservations=true`: per-study citations, and the life stages that would recover the dropped larval-host records | **open** — opened by V2.59 |
